...
class UnbalancedDisk(gym.Env):
    def __init__(self,nvec=40, umax=3., dt = 0.025, render_mode='human'):
        ...
        self.action_space = spaces.Discrete(7)#5) #discrete
...
def Qlearn(env, nsteps=5000, callbackfeq=100, alpha=0.05,eps=0.999, gamma=0.9): # was alpha = 0.2 eps 0.2 gamma = 0.99
